...
\section{Contiki}
Contiki is an operating system designed for computers with severely constrained resources\cite{dunkels04contiki}. At the time of its original release in 2004 it was targeted at 8 bit microcontrollers, ROM in the order of 100 kB and RAM less than 20 kB\citep[1]{dunkels04contiki}. Power was usually supplies 
...
\paragraph{Security on the Internet} was, and is, as of today an unresolved issue in the author's opinion. Its architecture has always been open
* Protects everything fromt he network level and up
* Model
