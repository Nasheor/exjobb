...
\paragraph{The SPD's caches} are used for 1) speeding up matching 2) associating a selector for outgoing traffic with an SA in the SAD.

SPD-S outbound prot. traffic
SPD-O outbound nonprot. traffic
SPD-I inbound non
