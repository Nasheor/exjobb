...
The ECC algorithms along with IKEv2's management of cryptographic material are areas rife with opportunities for improvement. The later algorithm 
Point compression. Tables etc

Ingen kontakt. Ignorerad. Vad kan man vänta sig? Vilken roll har vi gente varandra? Gå tidigare? Vara med mig själv. Läsa och vänta? Vad ska man göra på promenaden? Varför ser hon inte att jag är nedstämd? Varför frågar hon inte?

Jag är ledsen för att jag blir bortstött och inte får kontakt. Var lite med henne. Dra sen och ta vara på dig själv.

På sikt måste jag tala med henne om den dåliga känslomässiga kontakten.
