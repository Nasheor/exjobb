...
Although tunnel mode is by far the most popular usage of IPsec, this thesis will not implement it as it becomes less relevant in an IoT environment, for a variety of reasons described in \prettyref{cha:doi}. Instead, the research will focus on the so called host mode where no encapsulation takes place.
...
\subsection{The AH and ESP protocol}
The AH and ESP protocols are described in RFC 4302 and 4303, respectively. 
Must support popular encryption types. % FORTSÄTT HÄR!
