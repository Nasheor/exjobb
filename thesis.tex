...
The fact that confidentiality protection is optional makes ESP services identical to that of AH's, but only under certain circumstances. In `Design and Implementation' it will be shown how this fact can be exploited.
...
\section{Automatic key management}%{Automatic negotiation of SAs (IKEv2)}
...
\subsection{Performing a handshake}
...
\subsection{Headers and Payloads}
IKEv2 payloads

Encryption payload's simmilarity to ESP
