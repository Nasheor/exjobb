...
The other peer consisted of Cooja's host using the Linux kernel's native IPsec implementation and Strongswan for IKEv2 services.
...
The established state machine was not implemented because of time constraints, but doing so is not difficult. This resulted in that the IKEv2 service doesn't recognize the Delete Payload and thus cannot delete SAs, nor can new Child SAs be created.
